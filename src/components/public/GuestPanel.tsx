...
const CITIES = [
  ...
  'Iloilo City',
  // Iloilo Province
  'Cabatuan', 'Dumangas', 'Guimbal', 'Janiuay', 'Leganes', 'Miagao',
  'Oton', 'Passi City', 'Pavia', 'Pototan', 'San Miguel', 'Santa Barbara', 'Tigbauan',
]
...
const BARANGAYS_BY_CITY: Record<string, string[]> = {
  ...
  // --- Iloilo Province ---
  'Cabatuan': ['Agdayao', 'Bagumbayan', 'Balabago', 'Bita', 'Bungca', 'Cabilauan', 'Cagbang', 'Cato', 'Esperanza', 'Guibuangan', 'Guno', 'Laylayan', 'Madarag', 'Mambawi', 'Manduyog', 'Passi', 'Poblacion Norte', 'Poblacion Sur', 'Quezon', 'Salcedo', 'San Jose', 'Santo Tomas', 'Sintacan', 'Tan-agan', 'Tuburan', 'Turog-turog'],
  'Dumangas': ['Bacolod', 'Bagumbayan', 'Balabag', 'Balud', 'Bancal', 'Baras', 'Bolhog', 'Calaboa', 'Calayo', 'Carmelo', 'Casapatan', 'Cato', 'Dawis', 'Ilang-Ilang', 'Libo-on Dalipe', 'Mabigo', 'Macalbang', 'Macatol', 'Malusgod', 'Nabitasan', 'Natividad', 'Paloc Bigque', 'Paloc Sool', 'Panayon', 'Patag', 'Poblacion', 'Pulao', 'Pungtod Daot', 'San Pedro', 'San Roque', 'Sarabia', 'Sinibaran', 'Taminla', 'Tubigan', 'Tulatula Norte', 'Tulatula Sur', 'Zaido'],
  ...
  'Miagao': ['Agdum', 'Alimodian', 'Bacolod', 'Bacorong', 'Badiang', 'Bagumbayan', 'Balibagan', 'Barangay I', 'Barangay II', 'Barangay III', 'Barangay IV', 'Barangay V', 'Barangay VI', 'Barangay VII', 'Barangay VIII', 'Barangay IX', 'Barangay X', 'Barangay XI', 'Barangay XII', 'Barangay XIII', 'Batuan', 'Bita-og', 'Bulaqueña', 'Bularan', 'Bungahan', 'Bungan', 'Cabilauan', 'Cagbanaba', 'Cagbano', 'Caipilan', 'Calagtangan', 'Calamaisan', 'Calbari', 'Casanayan', 'Caticlan', 'Cawayan', 'Cubay', 'Dawog', 'Gebio-an', 'Guisian', 'Igbago', 'Igpalge', 'Ilaya', 'Imbon', 'Indag-an', 'Kirayan Norte', 'Kirayan Tacas', 'Laglag', 'Lanot', 'Locse', 'Mabayan', 'Macaronao', 'Mambatad', 'Narat-an', 'Pajo', 'Pamuringao Proper', 'Panuran', 'Sibunag', 'Siol Norte', 'Tabucan', 'Tacas', 'Tacdangan', 'Tando', 'Tinaytayan', 'Tipolo', 'To-og', 'Tubog', 'Tuburan Norte', 'Tuburan Sur', 'Ubos'],
  'Oton': ['Aguinaldo', 'Bacolod', 'Bagongbong', 'Bantud', 'Batiano', 'Bito-on Barangay I', 'Bito-on Barangay II', 'Botong', 'Buaya', 'Cabanbanan', 'Caboloan', 'Cagbang', 'Calubian', 'Capao', 'Carangahan', 'Casualan', 'Dungon', 'Esteban', 'Fundidor', 'Ge-awang', 'Janipaan Este', 'Janipaan Oeste', 'Janipaan Natalio', 'Janipaan Melchor', 'Jorog', 'Lanot', 'Libo-on Mabasa', 'Majanlud', 'Malabor', 'Mambusao', 'Mansaya', 'Mansila', 'Moroboro', 'Napnapan', 'Narat-an', 'Pagotpot', 'Pangi', 'Pantalan Nabaye', 'Pantalan Navarro', 'Poblacion', 'Polo', 'Puyas', 'Quezon Norte', 'Quezon Sur', 'Sa-ang', 'Salngan', 'San Antonio', 'San Nicolas', 'San Pedro', 'Santo Tomas', 'Sapa', 'Sipitan', 'Sog-ong', 'Tigum', 'Tiogon', 'Tuburan', 'Tugaslon', 'Tumagbok', 'Ungka I', 'Ungka II'],
  'Passi City': ['Agdayao', 'Aglobong', 'Agsalanan', 'Agtabo', 'Agtambo', 'Antonino', 'Ayaman', 'Bagumbayan', 'Batu', 'Bitaogan', 'Buenavista', 'Bugtong Lumboy', 'Bugtong Naulid', 'Cabalabaguan', 'Cabaruan', 'Cabugao', 'Calamian', 'Calaocan', 'Calleng', 'Camandag', 'Capitan Ramon', 'Caran', 'Cuyos', 'Dita', 'Estancia', 'Ferrer', 'Gines', 'Gutad', 'Lanas', 'Langca', 'Lawis', 'Linao', 'Luca', 'Mambog', 'Manticon', 'Matigu-an', 'Naba', 'Nipa', 'Pandan', 'Pantao', 'Pisao', 'Poblacion Ilawod', 'Poblacion Ilaya', 'Poblacion Tabuc', 'Punong', 'Quinagaringan', 'Sablogon', 'Salapadan', 'Salngan', 'Salvacion', 'Ticuan', 'Tugas', 'Tugaslon', 'Ugsod', 'Wigan'],
  'Pavia': ['Aganan', 'Ampid', 'Balabag', 'Balijuagan', 'Barasan Este', 'Barasan Oeste', 'Bohnon', 'Buyuan', 'Caingin', 'Cairohan', 'Dawag', 'Guinhawa Norte', 'Guinhawa Sur', 'Inday', 'Libo-on Saging', 'Linao', 'Lubog', 'Malumpati', 'Naga', 'Napnapan Norte', 'Napnapan Sur', 'Narat-an', 'Omambong', 'Pantalan', 'Pavia Proper', 'San Agustin', 'San Pedro', 'Tacas', 'Tigum', 'Ungka I', 'Ungka II'],
  'Pototan': ['Aganan', 'Alupidian', 'Amamaros', 'Bagacay', 'Balabag', 'Balaticon', 'Banban', 'Bantayan', 'Bantud', 'Barasan', 'Batuan', 'Bongco', 'Buenavista', 'Buga', 'Cabilauan', 'Cagbang', 'Caguisanan', 'Calaughan', 'Callang', 'Calolot', 'Camandag', 'Canvenas', 'Caposong', 'Casit-an', 'Dawag', 'Ginalinan', 'Hipona', 'Inay-Inay', 'Jalandoni', 'Jito-o', 'Kagutayan', 'Lampaya', 'Lanot', 'Lawi', 'Linao', 'Lugta', 'Luthangan', 'Madarog', 'Mano', 'Marilag', 'Misi', 'Moroboro', 'Naslo', 'Navalas', 'Omadan', 'Pandan Espina', 'Poblacion Norte', 'Poblacion Sur', 'Punong', 'Quiasan', 'Rojas', 'Sambag', 'San Agustin', 'San Antonio', 'San Marcos', 'San Pedro', 'Siwalo', 'Suelo', 'Tabuc Norte', 'Tabuc Sur', 'Tabucan', 'Taminla', 'Tanao', 'Tinaytayan', 'Tugaslon', 'Tumcon'],
  'San Miguel': ['Anilao', 'Asluman', 'Baguingin-Lanot', 'Baluarte', 'Bantayan', 'Barasan', 'Batuan', 'Bongco', 'Buenavista', 'Bungca', 'Bunga', 'Burgos', 'Cabilauan', 'Cag-an', 'Camohonan', 'Candari', 'Candelaria', 'Capinahan', 'Caposong', 'Caray-caray', 'Dakay', 'Daria', 'Estanza', 'Girado', 'Gobonseng', 'Gubang', 'Igcabuad', 'Inogbong', 'Lanjagan', 'Lublub', 'Madarug', 'Manhug', 'Menan', 'Nagusan', 'Nalbugan', 'Oboob', 'Olango', 'Palauan', 'Pandan', 'Pasay', 'Poblacion', 'Polo', 'Purog', 'Quipot', 'Sagcup', 'Saliguipan', 'San Isidro', 'San Jose', 'San Nicolas', 'San Pedro', 'Sibagon', 'Sibucao', 'Silagon', 'Sinamhay', 'Sinogayan', 'Sulanga', 'Tabuc Ponong', 'Tabucan', 'Tagsalakan', 'Talongonan', 'Tamis', 'Ticuan', 'Tomina', 'Tugaslon', 'Tumao'],
  'Santa Barbara': ['Agusipan', 'Atimonan', 'Bagong Silang', 'Bagumbayan', 'Balabag', 'Balatucan', 'Banban', 'Barasan', 'Batiano', 'Bayunan', 'Buenavista', 'Bugasong', 'Bulo Norte', 'Bulo Sur', 'Bunsoran', 'Cabilauan', 'Cagbang', 'Caguyuman', 'Canabuan', 'Cansilayan', 'Capinahan', 'Casit-an', 'Dajao', 'Dalicanan', 'Duhawan', 'Guanko', 'Guinamacan', 'Guiso', 'Igcabugao', 'Igbaras', 'Ilang-Ilang', 'Lanas', 'Lipata', 'Logansing', 'Lundag', 'Malawog', 'Mambisoc', 'Mango', 'Matacong', 'Mincal', 'Nalbugan', 'Napnapan', 'Narat-an', 'Odiong', 'Pader', 'Palomoc', 'Pasileng Norte', 'Pasileng Sur', 'Patong-patong', 'Pitogo', 'Poblacion', 'Quinagayungan', 'Quinal-oan', 'Sablogon', 'Sacripante', 'Saladan', 'San Agustin', 'San Andres', 'San Antonio', 'San Fernando', 'San Isidro', 'San Jose', 'San Luis', 'San Marcos', 'San Miguel', 'San Pablo', 'San Pedro', 'San Ramon', 'San Roque', 'Santa Rita', 'Santo Tomas', 'Sian', 'Siba-an', 'Sulangan', 'Tabucan', 'Talagutac', 'Tambal', 'Tanque', 'Tigbauan', 'Timawa', 'Tinpas', 'Tipolo', 'Tumcon', 'Turog-turog', 'Utod', 'Wigan'],
